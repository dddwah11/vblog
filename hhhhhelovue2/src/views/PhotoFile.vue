...
<template>
    <div>
      ...
      <div style="display:flex">
            ...
            class="upload-demo"
            :headers="headers"
            action="http://www.lhzzz-61.top/api/file/uploadPhoto"
            list-type="picture"
          :on-change="handleChange"
          >
            <el-button size="small" type="primary">点击上传图片(阿里云oss)</el-button>
          ...
          <el-upload
            class="upload-demo"
            :headers="headers"
            action="http://www.lhzzz-61.top/api/minio/uploadPhoto"
            list-type="picture"
          :on-change="handleChange"
          >
            <el-button size="small" type="primary">点击上传图片(minio)</el-button>
          </el-upload>
        </div>
  ...
  <script>
  import {  deletedById,findListPhoto } from "@/api/file";
  export default {
    data() {
      return {
        tableData: [],
    ...
    methods: {
      async selectByPage() {
        const { data: res } = await findListPhoto();
