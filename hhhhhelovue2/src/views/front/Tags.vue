...
<template>
  <div>
    <div class="home">
      <!-- banner -->
      <div class="banner">
        <div class="main animated zoomIn">类别</div>
      </div>
      <!-- content -->
      <div class="m-home animated fadeInLeft">
        <el-card class="viewcard">
          <div style="float: left; margin-top: -10px"><h1>类别</h1></div>
...
import { catTotal, getTagList } from "@/api/blog/category";
import { findBlog, findByTag } from "@/api/blog/article";
export default {
  data() {
    return {
      dataList: [],
  ...
  methods: {
    ...
    async handChange(tagId) {
      const { data: res } = await findByTag(tagId);
...
.banner {
  ...
  // background: url("https://xitong-parent.oss-cn-hangzhou.aliyuncs.com/2022/09/03/6ca427a8caf64115b68b3983d19afae4.jpg") center center / cover;
